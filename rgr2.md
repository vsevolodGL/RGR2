...
Файл: `RGR2_D-1_X1-X4.csv`.

$$
n=99, \qquad \alpha=0.05
$$
...
Ошибка первого рода: отвергнуть равенство математических ожиданий X<sub>1</sub> и X<sub>2</sub>, хотя они равны. Гипотеза H<sub>0</sub> отвергается; среднее X<sub>2</sub> статистически значимо выше среднего X<sub>1</sub>. Решение принято на основе двухвыборочного t-критерия Стьюдента.
...
Ошибка первого рода: отвергнуть равенство математического ожидания X<sub>3</sub> числу 100.0, хотя оно верно. Гипотеза H<sub>0</sub> отвергается; математическое ожидание X<sub>3</sub> статистически значимо отличается от 100.0. Решение принято на основе одновыборочного t-критерия.
...
$$
U_1=3715.50000,\qquad U_2=6085.50000.
$$

$$
U=\min(U_1,U_2)=3715.50000.
$$

$$
E[U]=4900.50000,\qquad D[U]=162532.99873.
$$
...
Ошибка первого рода: отвергнуть однородность распределений X<sub>1</sub> и X<sub>2</sub>, хотя распределения одинаковы. Гипотеза H<sub>0</sub> отвергается; X<sub>1</sub> и X<sub>2</sub> статистически значимо различаются. Решение принято на основе критерия Манна-Уитни.
...
Ошибка первого рода: отвергнуть согласие X<sub>4</sub> с Exp(lambda=0.2), хотя эта модель верна. Нет оснований отвергнуть H<sub>0</sub>; выборка X<sub>4</sub> не противоречит экспоненциальному распределению с параметром lambda=0.2. Решение принято на основе критерия согласия Пирсона.
